...
import {
  EventJobsOutboxRunner,
  EventEventQueueRunner,
...
async function bootstrap() {
  ...
  logger.info('Outbox runner for event starting...');
  ...
  const jobsRunner = new EventJobsOutboxRunner(
    jobsRepository,
    config.outbox,
    logger,
    jobsPusher,
  ...
  const eventsRunner = new EventEventQueueRunner(
    eventsRepository,
    config.outbox,
    logger,
    eventsPusher,
