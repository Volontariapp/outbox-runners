...
import {
  SocialJobsOutboxRunner,
  SocialEventQueueRunner,
...
async function bootstrap() {
  ...
  logger.info('Outbox runner for social starting...');
  ...
  const jobsRunner = new SocialJobsOutboxRunner(
    jobsRepository,
    config.outbox,
    logger,
    jobsPusher,
  ...
  const eventsRunner = new SocialEventQueueRunner(
    eventsRepository,
    config.outbox,
    logger,
    eventsPusher,
